<?php
    ...
    //$id = $row['id'];
    $id1 = $_GET['id'];
    $sql = mysqli_query( $conn ,"select * from user where id = $id1");
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12 p-2">
                            <?php
                                $sql1 = "select * from post where id_user = $id1  order by time desc";
                                    ...
                                    while($row1 = $result->fetch_assoc()) {
                                        echo "<div class='row p-2'>";
                                            echo "<div class='card mb-6'>";
                                                echo "<div class='card-header'><h3 class='float-left'>".$row['name']."</h3></div>";
                                                echo '<img src="./images/'.$row1["images"].'" alt='.$row["name"].' width="550" class="rounded mx-auto d-block">';
                                                ...
                                                echo "<div class='card-body'>";
                                                    echo "<div class='bg-white'>";
                                                        echo "<div class='d-flex flex-row fs-12'>";
                                                            echo "<div class='like p-2 cursor'><i class='fa fa-thumbs-o-up'></i><span class='ml-1'>Like</span></div>";
